...
cf2py   integer optional, intent(in):: nj=len(xj)
cf2py   real*8 dimension(nj), intent(in) :: xj
cf2py   real*8 dimension(nj), intent(in) :: yj
cf2py   real*8 dimension(nj), intent(in) :: zj
cf2py   complex*16 dimension(nj), intent(in) :: cj
cf2py   integer intent(in):: iflag
cf2py   real*8 intent(in):: eps
cf2py   integer intent(in) :: ms
cf2py   integer intent(in):: mt
cf2py   integer intent(in):: mu
cf2py   complex*16 dimension(1.0 * ms + 0.5,1.0 * mt + 0.5,1.0 * mu + 0.5), intent(out), allocatable :: fk
...
cf2py   real*8 dimension(nj), intent(in) :: yj
cf2py   real*8 dimension(nj), intent(in) :: zj
cf2py   complex*16 dimension(nj), intent(out) :: cj
cf2py   integer intent(in):: iflag
cf2py   real*8 intent(in):: eps
cf2py   integer, intent(in) :: ms=shape(fk,0)
cf2py   integer, intent(in):: mt=shape(fk,1)
cf2py   integer, intent(in):: mu=shape(fk,2)
cf2py   complex*16 dimension(1.0 * ms + 0.5,1.0 * mt + 0.5,1.0 * mu + 0.5), intent(in) :: fk
cf2py   integer intent(out):: ier
