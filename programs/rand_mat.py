...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="random rotation matrices and save them to a pickle file")
    parser.add_argument('n', metavar='number of matrices', type=int, help='amount of matrices to random')
    ...
    # if len(sys.argv) != 3:
    #      "Usage: n - number of matrices to generate, to_file - path to save the matrices"
