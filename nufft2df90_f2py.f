...
cf2py real*8 intent(in), dimension(nj) :: xj
cf2py real*8 intent(in), dimension(nj) :: yj
cf2py complex*16 intent(in), dimension(nj) :: cj
cf2py integer intent(in) :: iflag
cf2py real*8 intent(in) :: eps
cf2py integer intent(in) :: ms
cf2py integer intent(in) :: mt
cf2py complex*16 intent(out), dimension(ms, mt), allocatable :: fk
...
cf2py integer intent(in) :: iflag
cf2py real*8 intent(in) :: eps
cf2py integer optional, intent(in) :: ms=shape(fk,0)
cf2py integer optional, intent(in) :: mt=shape(fk,1)
cf2py complex*16 intent(in), dimension(ms, mt) :: fk
cf2py complex*16 intent(out), dimension(nj) :: cj
cf2py integer intent(out) :: ier
